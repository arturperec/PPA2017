...
import some.weird.ppafirebaselogin2017.Adapters.RecyclerViewAdapter;
...
public class FirebaseDatabaseHelper {
    ...
    public void createUserInFirebaseDatabase(String userId, FirebaseUserEntity firebaseUserEntitiy){
        Map<String, FirebaseUserEntity> user = new HashMap<String, FirebaseUserEntity>();
        user.put(userId, firebaseUserEntitiy);
